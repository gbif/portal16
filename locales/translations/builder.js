...
function builder(locale) {
    ...
    let translations = _.merge(
        ...
        getFile(locale, `./${locale}/components/ocurrenceFieldNames`),
        getFile(locale, `./${locale}/components/occurrenceKey`),
        ...
        getFile(locale, `./${locale}/components/healthDetails`),
        getFile(locale, `./${locale}/components/healthSummary`),
        getFile(locale, `./${locale}/components/installation`),
