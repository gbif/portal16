...
let config = {
    ...
    prodsolr: {
        ...
        root: rootPath,
        app: {
            name: 'portal - prodsolr'
        },
        port: port || 80,
        serverProtocol: 'http:',
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif.org/',
        dataApiV2: dataApiV2 || '//api-solr.gbif.org/v2/',
        dataApi: dataApi || '//api-solr.gbif.org/v1/',
        tileApi: tileApi || '//api-solr.gbif.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif.org',
        identityApi: identityApi || '//api-solr.gbif.org/v1/',
        analyticsImg: analyticsImg || 'www-solr.gbif.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-solr.gbif.org',
        topDomain: 'gbif.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
    ...
    prodes: {
        ...
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif.org/',
        dataApiV2: dataApiV2 || '//api-es.gbif.org/v2/',
        dataApi: dataApi || '//api-es.gbif.org/v1/',
        tileApi: tileApi || '//api-es.gbif.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif.org',
        identityApi: identityApi || '//api-es.gbif.org/v1/',
        analyticsImg: analyticsImg || 'www-es.gbif.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-es.gbif.org',
        topDomain: 'gbif.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
