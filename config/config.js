...
let config = {
    ...
    dev: {
        ...
        analyticsImg: analyticsImg || 'old.gbif-dev.org/sites/default/files/gbif_analytics/',
        domain: 'https://old.gbif-dev.org',
        ...
        contentfulPreviewApi: contentfulPreviewApi || 'https://preview.contentful.com/',
        elasticContentful: elasticContentful || 'http://core-search-1.gbif-dev.org:32329',
        registry: registry || 'http://c6p5.gbif-test.org:32614',
        elk: elk || '//privatelogs2-vh.gbif.org:5601/',
        publicKibana: publicKibana || '//logs.gbif.org/',
        kibanaIndex: kibanaIndex || '36e5ccd0-fdb1-11ea-93de-b97c40066ce8',
        locales: localeConfig.locales,
    ...
    uat: {
        ...
        contentfulApi: contentfulApi || 'https://cdn.contentful.com/',
        contentfulPreviewApi: contentfulPreviewApi || 'https://preview.contentful.com/',
        elasticContentful: elasticContentful || 'http://core-search-1.gbif-test.org:32735',
    ...
    staging: {
        ...
        contentfulApi: contentfulApi || 'https://cdn.contentful.com/',
        contentfulPreviewApi: contentfulPreviewApi || 'https://preview.contentful.com/',
        elasticContentful: elasticContentful || 'http://core-search-1.gbif.org:31857/',
    ...
    test: {
        ...
        analyticsImg: analyticsImg || 'www.gbif-test.org/sites/default/files/gbif_analytics/',
        domain: 'https://www.gbif-test.org',
        topDomain: 'gbif-test.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
