...
const localEnvironmentPostFix = '-uat2'; // e.g. '-uat';
let config = {
    local: {
        env: 'dev',
        healthEnv: 'uat',
    ...
    uat2: {
        ...
        serverProtocol: 'http:',
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif-uat2.org/',
        dataApiV2: dataApiV2 || '//api.gbif-uat2.org/v2/',
        dataApi: dataApi || '//api.gbif-uat2.org/v1/',
        sourceArchive: sourceArchive || `//source-archive.gbif-uat2.org/`,
        graphQLApi: graphQLApi || `//graphql.gbif-uat2.org/graphql`,
        tileApi: tileApi || '//api.gbif-uat2.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif-uat2.org',
        identityApi: identityApi || '//api.gbif-uat2.org/v1/',
        analyticsImg: analyticsImg || 'www.gbif-uat2.org/sites/default/files/gbif_analytics/',
        domain: 'https://www.gbif-uat2.org',
        topDomain: 'gbif-uat2.org',
        grscicollDomain: `https://grscicoll.hp.gbif-uat2.org`,
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
        verification: verification || '/var/lib/human-verification/images',
        ...
        registry: registry || 'https://registry.gbif-uat2.org',
        elk: elk || '//private-logs.gbif-uat2.org:5601/',
        publicKibana: publicKibana || '//logs.gbif.org/',
        kibanaIndex: kibanaIndex || '782daf00-fdb1-11ea-93de-b97c40066ce8',
        locales: localeConfig.locales,
        defaultLocale: localeConfig.defaultLocale,
