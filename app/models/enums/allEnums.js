module.exports = {
    ...
    "cms": {
        ...
        "category_purpose": require('./cms/category_purpose.json'),
        "category_data_use": require('./cms/category_data_use.json'),
        "category_capacity_enhancement": require('./cms/category_capacity_enhancement.json'),
        "category_topic": require('./cms/category_topic.json')
    }
};
