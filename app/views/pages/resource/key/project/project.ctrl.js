...
/** @ngInject */
function projectKeyCtrl(DatasetSearch, $q, env, $http, $location, ResourceSearch, $rootScope, BUILD_VERSION) {
    var vm = this;
    ...
    vm.literature = ResourceSearch.query({contentType: 'literature', gbifProjectIdentifier: vm.projectId, limit: 0});
