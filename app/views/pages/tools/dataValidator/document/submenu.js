...
function updateMenu() {
    if (document.compatMode == 'CSS1Compat') {
        let tabsFixedContainer = document.getElementById('tabsFixedContainer');
    ...
    function positionSubmenu() { // eslint-disable-line no-inner-declarations
        ...
        let submenu = document.getElementById('submenu');
        if (submenuWrapper) {
            let subMenuWrapperPosition = submenuWrapper.getBoundingClientRect();
...
function updateTabs() {
    ...
    function positionTabsBar() { // eslint-disable-line no-inner-declarations
        ...
        if (tabsScrollable && tabsFixedContainer) {
            let tabsScrollablePosition = tabsScrollable.getBoundingClientRect();
