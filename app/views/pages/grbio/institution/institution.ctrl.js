...
angular
    .module('portal')
    .controller('grbioInstitutionCtrl', grbioInstitutionCtrl);

/** @ngInject */
function grbioInstitutionCtrl(Page, $state, $stateParams, InstitutionSearch) {
    var vm = this;
    vm.limit = 20;
...
module.exports = grbioInstitutionCtrl;
