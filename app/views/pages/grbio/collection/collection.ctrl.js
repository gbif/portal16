...
angular
    .module('portal')
    .controller('grbioCollectionCtrl', grbioCollectionCtrl);

/** @ngInject */
function grbioCollectionCtrl(Page, $state, $stateParams, CollectionSearch) {
    var vm = this;
    vm.limit = 20;
...
module.exports = grbioCollectionCtrl;
