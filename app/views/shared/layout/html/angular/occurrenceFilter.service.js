...
angular
    ...
    .service('OccurrenceFilter', function($rootScope, $state, $stateParams, OccurrenceTableSearch) {
        ...
        let exhaustiveFacetsKeys = ['establishment_means', 'basis_of_record', 'month', 'type_status', 'issue', 'dataset_key', 'institution_code', 'country', 'media_type', 'license', 'protocol', 'publishing_org'];
        ...
        let multiSelectFacetsKeys = ['establishment_means', 'dataset_key', 'institution_code', 'basis_of_record', 'country', 'month', 'media_type', 'type_status', 'issue', 'license', 'publishing_org'];
        ...
        if (!state.query.advanced) {
            for (let key in advancedDefaults) {
