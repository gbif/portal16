...
function routerConfig($stateProvider, $locationProvider, BUILD_VERSION) {
    ...
    $stateProvider
        ...
        .state('resourceSearch', {
            parent: 'localization',
            url: '/resource?offset&limit&q&contentType&year&literatureType&language&audiences&purposes&topics&relevance&countriesOfResearcher&countriesOfCoverage&_showPastEvents&gbifDatasetKey&publishingOrganizationKey&gbifDownloadKey&peerReview',
            views: {
                main: {
