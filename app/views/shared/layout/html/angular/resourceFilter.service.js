...
angular
    ...
    .service('ResourceFilter', function($rootScope, $state, $stateParams, ResourceSearch) {
        ...
        var exhaustiveFacetsKeys = ['year', 'gbifProgrammeAcronym', 'contentType', 'literatureType', 'language', 'audiences', 'purposes', 'source', 'publisher', 'topics', 'countriesOfResearcher', 'countriesOfCoverage', 'relevance', 'contractCountry'];
