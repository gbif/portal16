var env = {
    dataApiV2: '//api.gbif.org/v2/', //e.g //api.gbif.org/v2/
    dataApi: '//api.gbif.org/v1/', //e.g //api.gbif.org/v1/
    tileApi: '//api.gbif.org/v1/map/density/tile.png', //e.g. //cdn.gbif.org/v1/map/density/tile.png
    cmsApi: '//cms-api.gbif.org/api/',   //e.g. //cms.gbif-dev.org/api/
