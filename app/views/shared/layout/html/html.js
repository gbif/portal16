...
(function () {
    ...
    function runBlock(amMoment, $translate, $http, LOCALE, $rootScope) { //$log
        ...
        //$anchorScroll.yOffset = 60; //TODO @Thomas - i like it, but it gives issue elsewhere. Lets talk when you get back about how to approach this. I don't know what the best way is. Adding it result in issues on other pages. So far I have ben doing it with anchor offsets in css instead.
        $http({
            method: 'GET',
...
require('../../../components/filterFacetSuggest/filterFacetSuggest.directive');
