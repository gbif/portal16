...
function enumFilterDirective(BUILD_VERSION) {
    ...
    function enumFilter($scope, $filter) {
        ...
        vm.getWidth = function(enumName) {
            ...
            let fraction = vm.filterState.data.facets[vm.facetKey].counts[enumName].fraction;
            let gear = 100 / (vm.filterState.data.facets[vm.facetKey].max / vm.filterState.data.count);
