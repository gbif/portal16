...
angular
    .module('portal')
    .directive('filterFacetSuggest', filterFacetSuggestDirective);

/** @ngInject */
function filterFacetSuggestDirective(BUILD_VERSION) {
    var directive = {
        restrict: 'A',
        transclude: true,
        templateUrl: '/templates/components/filterFacetSuggest/filterFacetSuggest.html?v=' + BUILD_VERSION,
        scope: {
            filterState: '=',
            filterConfig: '='
        },
        replace: true,
        controller: filterFacetSuggest,
        controllerAs: 'vm',
    ...
    /** @ngInject */
    function filterFacetSuggest($scope, $filter) {
        var vm = this;
        vm.disabled = false;
...
module.exports = filterFacetSuggestDirective;
