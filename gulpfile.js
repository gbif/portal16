...
gulp.task('watch', ['browser-sync'], function () {
    ...
    gulp.watch([config.js.client.watch], ['scripts-reload', 'dataRepo'/*, 'client-lint'*/]); //, 'dataRepo', 'speciesLookup', 'dataValidator', 'ipt', 'observationTrends', 'home'//removed because they are slow to wait for. If you are developing this add again. Not ideal, but it seem to slow things down quite a bit
